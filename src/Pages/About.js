        ...
        <>
            ...
            <Row >
                ...
                <Col style={alignText} span={20} sm={20} md={15} lg={15} xl={15} >
                    ...
                    <div>
                        <span>Fllow me: </span>
                        <a href='#'><GithubOutlined style={{ color: '#000', fontSize: '30px', marginLeft: '10px' }} /></a>
                        <a href='#'><FacebookFilled style={{ color: '#4267b2', fontSize: '30px', marginLeft: '10px' }} /></a>
                        <a href='#'><TwitterOutlined style={{ color: '#1DA1F2', fontSize: '30px', marginLeft: '10px' }} /></a>
                        <a href='#'><YoutubeFilled style={{ color: '#EA4335', fontSize: '30px', marginLeft: '10px' }} /></a>
                    </div>
                </Col>
            </Row>
        </>
